    ...
    >
      ...
      <div>
        ...
        <motion.div variants={fadeInUp} className="mt-5">
          <p className="text-foregroundClr">Total Reviews</p>
          <h3 className="text-2xl font-semibold text-neutral-800">323</h3>
        </motion.div>
      </div>
      ...
      <motion.div
        variants={fadeInUp}
        className="flex items-center flex-wrap gap-2 border border-accent1 max-w-max p-3 rounded-full mt-10"
      >
